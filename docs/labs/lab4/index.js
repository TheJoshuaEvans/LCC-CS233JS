...
class ToDoList {
   ...
   */
  addTask(...args) {console.log('addTask', args);}
  addEventHandlers(...args) {console.log('addEventHandlers', args);}
  loadTask(...args) {console.log('loadTask', args);}
  generateTaskHtml(...args) {console.log('generateTaskHtml', args);}
  toggleTaskStatus(...args) {console.log('toggleTaskStatus', args);}
  deleteTask(...args) {console.log('deleteTask', args);}
}
